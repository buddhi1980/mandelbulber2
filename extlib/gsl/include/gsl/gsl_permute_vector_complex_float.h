...
GSL_FUN int gsl_permute_vector_complex_float (const gsl_permutation * p, gsl_vector_complex_float * v);
GSL_FUN int gsl_permute_vector_complex_float_inverse (const gsl_permutation * p, gsl_vector_complex_float * v);
