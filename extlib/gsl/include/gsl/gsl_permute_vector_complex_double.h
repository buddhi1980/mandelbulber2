...
GSL_FUN int gsl_permute_vector_complex (const gsl_permutation * p, gsl_vector_complex * v);
GSL_FUN int gsl_permute_vector_complex_inverse (const gsl_permutation * p, gsl_vector_complex * v);
