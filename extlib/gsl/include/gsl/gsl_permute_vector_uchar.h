...
GSL_FUN int gsl_permute_vector_uchar (const gsl_permutation * p, gsl_vector_uchar * v);
GSL_FUN int gsl_permute_vector_uchar_inverse (const gsl_permutation * p, gsl_vector_uchar * v);
