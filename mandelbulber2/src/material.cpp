...
QStringList cMaterial::paramsList = {
	"color_texture_intensity", "coloring_palette_offset", "coloring_palette_size",
	"coloring_random_seed", "coloring_saturation", "coloring_speed", "diffusion_texture_intensity",
	"displacement_texture_height", "file_color_texture", "file_diffusion_texture",
	"file_displacement_texture", "file_luminosity_texture", "file_normal_map_texture",
	"fractal_coloring_add_enabled_false", "fractal_coloring_add_max", "fractal_coloring_add_spread",
	"fractal_coloring_add_start_value", "fractal_coloring_algorithm",
