...
//FIXME			cProgressText::ProgressStatusText(
...
//			);
	...
	//FIXME cProgressText::ProgressStatusText(QObject::tr("Animation finished"), progressText.getText(1.0), 1.0, cProgressText::progress_ANIMATION);
