...
void DefineFractalList(QList<sFractalDescription> *fractalList)
{
	...
	fractalList->append(sFractalDescription("Mandelbulb", 										"mandelbulb", 							mandelbulb, 						analitycDEType, logarithmicDEFunction));
	...
	fractalList->append(sFractalDescription("Ides Formula", 									"ides", 										ides, 									deltaDEType, 		logarithmicDEFunction));
	...
	fractalList->append(sFractalDescription("Mandelbulb - extended", 					"mandelbulb5", 							mandelbulb5, 						analitycDEType, logarithmicDEFunction));
	...
	fractalList->append(sFractalDescription("Mandelbulb6 beta", 							"mandelbulb6_beta", 				mandelbulb6Beta, 				analitycDEType, logarithmicDEFunction));
  ...
  fractalList->append(sFractalDescription("AboxMod1", 											"aboxMod1", 								aboxMod1, 							analitycDEType, linearDEFunction));
	...
	fractalList->append(sFractalDescription("Transform - Addition Constant",	"transf_addition_constant", transfAdditionConstant, analitycDEType,	withoutDEFunction));
	fractalList->append(sFractalDescription("Transform - Rotation",						"transf_rotation", 					transfRotation, 				analitycDEType,	withoutDEFunction));
	fractalList->append(sFractalDescription("Transform - Scale",							"transf_scale", 						transfScale, 						analitycDEType,	withoutDEFunction));
	fractalList->append(sFractalDescription("Transform - Scale 3D",						"transf_scale_3D", 					transfScale3D, 					analitycDEType,	withoutDEFunction));
