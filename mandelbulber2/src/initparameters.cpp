...
void InitFractalParams(cParameterContainer *par)
{
  ...
  par->addParam("menger_sponge105_sphericalFold1_stop_iterations", 250, morphLinear, paramStandard);
  ...
  par->addParam("menger_sponge105_main_rotation1_stop_iterations", 250, morphLinear, paramStandard);
  par->addParam("menger_sponge105_main_rotation1", CVector3(0.0, 0.0, 0.0), morphAkimaAngle, paramStandard);
  par->addParam("menger_sponge105_main_rotation1_weight", 1.0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsAddConstant1_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsAddConstant1_weight_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsAddConstant1_enabled_x", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsAddConstant1_enabled_y", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsAddConstant1_enabled_z", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsAddConstant1_start_iterations", 0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsAddConstant1_stop_iterations", 250, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsAddConstant1A", CVector3(0.0, 0.0, 0.0), morphAkima, paramStandard);
  ...
  par->addParam("menger_sponge105_constantMultiplier1_stop_iterations", 250, morphLinear, paramStandard);
  par->addParam("menger_sponge105_constantMultiplier1", CVector3(0.0, 0.0, 0.0), morphAkima, paramStandard);
  par->addParam("menger_sponge105_constantMultiplier1_weight", 1.0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_additionConstant1_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_additionConstant1_weight_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_additionConstant1_start_iterations", 0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_additionConstant1_stop_iterations", 250, morphLinear, paramStandard);
  par->addParam("menger_sponge105_additionConstant1", CVector3(0.0, 0.0, 0.0), morphAkima, paramStandard);
  par->addParam("menger_sponge105_additionConstant1_weight", 1.0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1A", CVector3(0.0, 0.0, 0.0), morphAkima, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1B", CVector3(0.0, 0.0, 0.0), morphAkima, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1C", CVector3(1.0, 1.0, 1.0), morphAkima, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1D", CVector3(0.0, 0.0, 0.0), morphAkima, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1_weight_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1_enabled_Ax", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1_enabled_Ay", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1_enabled_Az", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1_enabled_Bx", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1_enabled_By", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1_enabled_Bz", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1_start_iterations", 0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1_stop_iterations", 250, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD1_weight", 1.0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_main_rotation2_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_main_rotation2_weight_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_main_rotation2_start_iterations", 0, morphLinear, paramStandard);
  ...
  par->addParam("menger_sponge105_boxOffset2_stop_iterations", 250, morphLinear, paramStandard);
  par->addParam("menger_sponge105_boxOffset2", CVector3(0.0, 0.0, 0.0), morphAkima, paramStandard);
  par->addParam("menger_sponge105_boxOffset2_weight", 1.0, morphLinear, paramStandard);


  par->addParam("menger_sponge105_box_fold2_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_box_fold2_weight_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_box_fold2_start_iterations", 0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_box_fold2_stop_iterations", 250, morphLinear, paramStandard);
  par->addParam("menger_sponge105_box_fold2_folding_limit", 1.0, morphAkima, paramStandard);
  par->addParam("menger_sponge105_box_fold2_folding_value", 2.0, morphAkima, paramStandard);
  par->addParam("menger_sponge105_box_fold2_weight", 1.0, morphLinear, paramStandard);

  par->addParam("menger_sponge105_sphericalOffset2_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_sphericalOffset2_weight_enabled", false, morphLinear, paramStandard);
  ...
  par->addParam("menger_sponge105_sphericalFold2_weight_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_sphericalFold2_start_iterations", 0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_sphericalFold2_stop_iterations", 250, morphLinear, paramStandard);
  ...
  par->addParam("menger_sponge105_constantMultiplier2_stop_iterations", 250, morphLinear, paramStandard);
  par->addParam("menger_sponge105_constantMultiplier2", CVector3(0.0, 0.0, 0.0), morphAkima, paramStandard);
  par->addParam("menger_sponge105_constantMultiplier2_weight", 1.0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_additionConstant2_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_additionConstant2_weight_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_additionConstant2_start_iterations", 0, morphLinear, paramStandard);
  ...
  par->addParam("menger_sponge105_main_rotation3_stop_iterations", 250, morphLinear, paramStandard);
  par->addParam("menger_sponge105_main_rotation3", CVector3(0.0, 0.0, 0.0), morphAkimaAngle, paramStandard);
  par->addParam("menger_sponge105_main_rotation3_weight", 1.0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2A", CVector3(0.0, 0.0, 0.0), morphAkima, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2B", CVector3(0.0, 0.0, 0.0), morphAkima, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2C", CVector3(1.0, 1.0, 1.0), morphAkima, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2D", CVector3(0.0, 0.0, 0.0), morphAkima, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2_weight_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2_enabled_Ax", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2_enabled_Ay", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2_enabled_Az", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2_enabled_Bx", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2_enabled_By", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2_enabled_Bz", true, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2_start_iterations", 0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2_stop_iterations", 250, morphLinear, paramStandard);
  par->addParam("menger_sponge105_fabsFormulaABCD2_weight", 1.0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_iterationWeight1_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_iterationWeight1_weight_enabled", false, morphLinear, paramStandard);
  par->addParam("menger_sponge105_iterationWeight1_iterationA", 0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_iterationWeight1_iterationB", 0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_iterationWeight1_constantA", 0.0, morphLinear, paramStandard);
  par->addParam("menger_sponge105_iterationWeight1_constantB", 0.0, morphLinear, paramStandard);
