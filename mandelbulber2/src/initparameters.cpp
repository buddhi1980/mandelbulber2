...
void InitFractalParams(cParameterContainer *par)
{
  ...
  par->addParam("quaternion104_fabsAddConstant1_enabled_x", false, morphLinear, paramStandard);
  par->addParam("quaternion104_fabsAddConstant1_enabled_y", false, morphLinear, paramStandard);
  par->addParam("quaternion104_fabsAddConstant1_enabled_z", false, morphLinear, paramStandard);
  par->addParam("quaternion104_fabsAddConstant1W_enabled", false, morphLinear, paramStandard);
  ...
  par->addParam("quaternion104_quaternion2_factorConstantW", 2.0, morphAkima, paramStandard);
