...
void InitFractalParams(cParameterContainer *par)
{
	...
	par->addParam("mandelbulb5_absPreadd_iterations", 0, morphLinear, paramStandard);
	...
	par->addParam("mandelbulb5_main_rotation_iterations", 0, morphLinear, paramStandard);
