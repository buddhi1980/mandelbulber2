...
// mandelbulb multi
  ...
  par->addParam("transform_benesiMagTransformOne3_offset", CVector3(2.0, 2.0, 0.0), morphAkimaAngle, paramStandard);
  ...
  par->addParam("transform_benesiMagTransformTwo1_offset", CVector3(2.0, 0.0, 0.0), morphAkimaAngle, paramStandard);
  ...
  par->addParam("transform_benesiMagTransformFour1_offset", CVector3(2.0, 0.0, 0.0), morphAkimaAngle, paramStandard);
  ...
  par->addParam("transform_benesiMagTransformFour2_offset", CVector3(2.0, 0.0, 0.0), morphAkimaAngle, paramStandard);
