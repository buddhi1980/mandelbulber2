...
void SavePNG(QString filename, cImage *image, structSaveImageChannel imageChannel,
...
bool SaveJPEGQtGreyscale(QString filename, unsigned char *image, int width, int height,
		int quality);
