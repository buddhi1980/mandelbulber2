...
void mc_add_vertex(double x1, double y1, double z1, double c2,
    ...
    double colorIndex_1, double colorIndex_2, std::vector<double> *colorIndices);
}
            ...
            for(int k=0; k<numz; ++k)
            {
                ...
                if(edges & 0x040)
                {
                    ...
                    mc_add_vertex(x_dx, y_dy, z_dz, x, 0, v[6], v[7], isovalue, &vertices,
                            colorIndex[7], colorIndex[7], &colorIndices);
                }
                if(edges & 0x020)
                {
                    ...
                    mc_add_vertex(x_dx, y, z_dz, y_dy, 1, v[5], v[6], isovalue, &vertices,
                            colorIndex[5], colorIndex[6], &colorIndices);
                }
                if(edges & 0x400)
                {
                    ...
                    mc_add_vertex(x_dx, y+dx, z, z_dz, 2, v[2], v[6], isovalue, &vertices,
                            colorIndex[2], colorIndex[6], &colorIndices);
                }
                ...
                if(edges & 0x001)
                {
                    if(j == 0 || k == 0)
                    {
                      ...
                      mc_add_vertex(x, y, z, x_dx, 0, v[0], v[1], isovalue, &vertices,
                              colorIndex[0], colorIndex[1], &colorIndices);
                    }
                    else
                ...
                if(edges & 0x002)
                {
                    if(k == 0)
                    {
                        ...
                        mc_add_vertex(x_dx, y, z, y_dy, 1, v[1], v[2], isovalue, &vertices,
                                colorIndex[1], colorIndex[2], &colorIndices);
                    }
                    else
                ...
                if(edges & 0x004)
                {
                    if(k == 0)
                    {
                        ...
                        mc_add_vertex(x_dx, y_dy, z, x, 0, v[2], v[3], isovalue, &vertices,
                                colorIndex[2], colorIndex[3], &colorIndices);
                    }
                    else
                ...
                if(edges & 0x008)
                {
                    if(i == 0 || k == 0)
                    {
                        ...
                        mc_add_vertex(x, y_dy, z, y, 1, v[3], v[0], isovalue, &vertices,
                                colorIndex[3], colorIndex[0], &colorIndices);
                    }
                    else
                ...
                if(edges & 0x010)
                {
                    if(j == 0)
                    {
                        ...
                        mc_add_vertex(x, y, z_dz, x_dx, 0, v[4], v[5], isovalue, &vertices,
                                colorIndex[4], colorIndex[5], &colorIndices);
                    }
                    else
                ...
                if(edges & 0x080)
                {
                    if(i == 0)
                    {
                        ...
                        mc_add_vertex(x, y_dy, z_dz, y, 1, v[7], v[4], isovalue, &vertices,
                                colorIndex[7], colorIndex[4], &colorIndices);
                    }
                    else
                ...
                if(edges & 0x100)
                {
                    if(i == 0 || j == 0)
                    {
                        ...
                        mc_add_vertex(x, y, z, z_dz, 2, v[0], v[4], isovalue, &vertices,
                                colorIndex[0], colorIndex[4], &colorIndices);
                    }
                    else
                ...
                if(edges & 0x200)
                {
                    if(j == 0)
                    {
                        ...
                        mc_add_vertex(x_dx, y, z, z_dz, 2, v[1], v[5], isovalue, &vertices,
                                colorIndex[1], colorIndex[3], &colorIndices);
                    }
                    else
                ...
                if(edges & 0x800)
                {
                    if(i == 0)
                    {
                        ...
                        mc_add_vertex(x, y_dy, z, z_dz, 2, v[3], v[7], isovalue, &vertices,
                                colorIndex[3], colorIndex[7], &colorIndices);
                    }
                    else
