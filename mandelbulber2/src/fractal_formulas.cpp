...
void AboxTetra4dIteration(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	CVector4 CT = fabs(CVector4(aux.const_c.x + aux.const_c.y + aux.const_c.z,
...
void KochV2Iteration(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	else
	{
		...
		aux.dist = fabs(z.z - Offset.z) / aux.DE;
...
/**
 * Baird Delta
 * Based on formula coded by Knighty in fragmentarium:
 */
