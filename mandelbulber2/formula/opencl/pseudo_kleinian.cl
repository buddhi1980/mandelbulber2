...
void PseudoKleinianIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void PseudoKleinianIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
