...
void MandelbulbJuliabulbIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void MandelbulbJuliabulbIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	if (aux->i >= fractal->transformCommon.startIterationsM
			&& aux->i < fractal->transformCommon.stopIterationsM)
	{
