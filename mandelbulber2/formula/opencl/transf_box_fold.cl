...
void TransfBoxFoldIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void TransfBoxFoldIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	if (fabs(z->x) > fractal->mandelbox.foldingLimit)
	{
		z->x = copysign(fractal->mandelbox.foldingValue, z->x) - z->x;
