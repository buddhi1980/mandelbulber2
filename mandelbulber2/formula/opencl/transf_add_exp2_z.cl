...
DECIMAL4 TransfAddExp2ZIteration(DECIMAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	DECIMAL4 tempZ = z;
	...
	if (fractal->transformCommon.functionEnabledBzFalse)
	{
		...
		{
			tempS = fabs(z);
			DECIMAL4 tempT = tempS * -fractal->transformCommon.scale0;
		...
		{
			DECIMAL4 tempR = z * fractal->transformCommon.scale0;
