...
void TransfAddExp2ZIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	float4 tempZ = *z;
...
#else
void TransfAddExp2ZIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	double4 tempZ = *z;
