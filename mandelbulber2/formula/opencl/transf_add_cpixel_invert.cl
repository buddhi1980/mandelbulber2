...
REAL4 TransfAddCpixelInvertIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	if (!fractal->transformCommon.functionEnabledAxFalse) pc.x = 1.0f / pc.x;
	if (!fractal->transformCommon.functionEnabledAyFalse) pc.y = 1.0f / pc.y;
	if (!fractal->transformCommon.functionEnabledAzFalse) pc.z = 1.0f / pc.z;
