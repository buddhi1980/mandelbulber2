...
void PseudoKleinianStdDEIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void PseudoKleinianStdDEIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
