...
void AboxMod11Iteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void AboxMod11Iteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
