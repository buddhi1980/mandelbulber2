...
float4 MsltoeSym3ModIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 MsltoeSym3ModIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
