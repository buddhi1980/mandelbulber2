...
void TransfRotationFoldingIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	Q_UNUSED(aux);
	...
	*z = Matrix33MulFloat4(fractal->transformCommon.rotationMatrix, *z);
	...
	if (fractal->transformCommon.functionEnabled)
	{
		if (fractal->transformCommon.functionEnabledx)
			z->x =
				fabs(z->x + fractal->transformCommon.offset000.x) - fractal->transformCommon.offset000.x;
		if (fractal->transformCommon.functionEnabledy)
			z->y =
				fabs(z->y + fractal->transformCommon.offset000.y) - fractal->transformCommon.offset000.y;
		if (fractal->transformCommon.functionEnabledz)
			z->z =
				fabs(z->z + fractal->transformCommon.offset000.z) - fractal->transformCommon.offset000.z;
	}
...
#else
void TransfRotationFoldingIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	Q_UNUSED(aux);
