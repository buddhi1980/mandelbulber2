...
float4 AboxModKaliIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 AboxModKaliIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	z = fractal->transformCommon.additionConstant0555 - fabs(z);
	double rr = dot(z, z);
