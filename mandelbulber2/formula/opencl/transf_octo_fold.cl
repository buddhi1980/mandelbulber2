...
void TransfOctoFoldIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void TransfOctoFoldIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
