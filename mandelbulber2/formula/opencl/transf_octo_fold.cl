...
float4 TransfOctoFoldIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 TransfOctoFoldIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
