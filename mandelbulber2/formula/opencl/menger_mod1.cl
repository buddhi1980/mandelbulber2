...
float4 MengerMod1Iteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	z = fabs(z);
	if (z.x - z.y < 0.0f)
	{
...
#else
double4 MengerMod1Iteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	z = fabs(z);
	if (z.x - z.y < 0.0)
	{
