...
float4 TransfBenesiT1Iteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 TransfBenesiT1Iteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
