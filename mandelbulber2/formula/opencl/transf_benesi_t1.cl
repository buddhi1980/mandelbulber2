...
void TransfBenesiT1Iteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void TransfBenesiT1Iteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
