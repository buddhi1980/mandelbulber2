...
float4 TransfSphericalInvCIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 TransfSphericalInvCIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
