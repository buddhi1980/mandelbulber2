...
float4 BenesiT1PineTreeIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 BenesiT1PineTreeIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
