...
void TransfSurfBoxFoldIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	if (fractal->surfBox.enabledX1)
	{
		z->x = fabs(z->x + fractal->surfBox.offset1A111.x) - fabs(z->x - fractal->surfBox.offset1A111.x)
					 - z->x;
	}
	...
	{
		z->y = fabs(z->y + fractal->surfBox.offset1A111.y) - fabs(z->y - fractal->surfBox.offset1A111.y)
					 - z->y;
	}
	...
	{
		z->z = fabs(z->z + fractal->surfBox.offset1A111.z) - fabs(z->z - fractal->surfBox.offset1A111.z)
					 - z->z;
	}
...
#else
void TransfSurfBoxFoldIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	if (fractal->surfBox.enabledX1)
	{
		z->x = fabs(z->x + fractal->surfBox.offset1A111.x) - fabs(z->x - fractal->surfBox.offset1A111.x)
