...
void TransfPwr2PolynomialIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	float4 partA = *z;
...
#else
void TransfPwr2PolynomialIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	double4 partA = *z;
	if (fractal->transformCommon.functionEnabledFalse) // fabs
		partA = fabs(*z);
