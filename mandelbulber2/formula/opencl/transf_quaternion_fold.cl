...
void TransfQuaternionFoldIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	*z = (float4){z->x * z->x - z->y * z->y - z->z * z->z, z->x * z->y, z->x * z->z, z->w};
	if (fractal->transformCommon.functionEnabledFalse)
	{
		...
		*z *= fractal->transformCommon.constantMultiplier122;
		...
		float4 tempAvgScale =
			(float4){z->x, native_divide(z->y, 2.0f), native_divide(z->z, 2.0f), z->w};
...
#else
void TransfQuaternionFoldIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
