...
void GeneralizedFoldBoxIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	float3 zXYZ = z->xyz;
	int i;
...
#else
void GeneralizedFoldBoxIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	double3 zXYZ = z->xyz;
	int i;
