...
float4 MengerPrismShapeIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 MengerPrismShapeIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
