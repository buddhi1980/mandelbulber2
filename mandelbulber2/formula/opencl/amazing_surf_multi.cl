...
void AmazingSurfMultiIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	{ // enable *z scale
		float zLimit = fractal->transformCommon.foldingLimit * fractal->transformCommon.scale0;
		float zValue = fractal->transformCommon.foldingValue * fractal->transformCommon.scale0;
		if (fabs(z->z) > zLimit)
		{
...
#else
void AmazingSurfMultiIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
