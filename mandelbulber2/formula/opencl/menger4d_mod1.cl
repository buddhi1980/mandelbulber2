...
float4 Menger4dMod1Iteration(float4 *z4D, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 Menger4dMod1Iteration(double4 *z4D, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
