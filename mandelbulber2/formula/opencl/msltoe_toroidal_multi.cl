...
void MsltoeToroidalMultiIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void MsltoeToroidalMultiIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	if (fractal->transformCommon.functionEnabledFalse) // pre-scale
	{
		*z *= fractal->transformCommon.scale3D111;
