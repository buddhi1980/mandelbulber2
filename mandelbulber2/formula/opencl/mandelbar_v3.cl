 ...
 * from the file "fractal_mandelbar_v3.cpp" in the folder formula/definition
 * D O    N O T    E D I T    T H I S    F I L E !
 */

REAL4 MandelbarV3Iteration(REAL4 z, __global sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	if (fractal->transformCommon.functionEnabledAwFalse)
	{
		...
		REAL rLg = 0.0f;
		if (r > 1.0f) rLg = 0.5f * log(r) * r / aux->DE;
