...
void TransfSphericalInvIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void TransfSphericalInvIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
