...
float4 TransfSphericalInvIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	float r2Temp = dot(z, z);
...
#else
double4 TransfSphericalInvIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	double r2Temp = dot(z, z);
	z += fractal->mandelbox.offset;
	z *= fractal->transformCommon.scale;
