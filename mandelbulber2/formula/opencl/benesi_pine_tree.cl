...
float4 BenesiPineTreeIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 BenesiPineTreeIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
