...
REAL4 TestingIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
			...
			&& aux->i < fractal->transformCommon.stopIterationsA)
	{
		...
		native_sqrt(fractal->foldingIntPow.zFactor * fractal->foldingIntPow.zFactor + 2.0f
													+ fractal->analyticDE.offset2), fractal->analyticDE.offset1);
		}
		else
		{
			aux->r_dz = aux->r * aux->r_dz * 16.0f * fractal->analyticDE.scale1
									 * native_divide(native_sqrt(fractal->foldingIntPow.zFactor *
		fractal->foldingIntPow.zFactor + 2.0f
													+ fractal->analyticDE.offset2), SQRT_3)
