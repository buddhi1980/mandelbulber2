...
void TransfSphericalFoldIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	float r2 = dot(*z, *z);
...
#else
void TransfSphericalFoldIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	double r2 = dot(*z, *z);
