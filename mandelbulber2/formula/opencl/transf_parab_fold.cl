...
void TransfParabFoldIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	float4 temp = *z;
...
#else
void TransfParabFoldIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	double4 temp = *z;
