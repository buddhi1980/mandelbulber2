...
void TransfAddCpixelVaryV1Iteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	float4 tempVC = fractal->transformCommon.constantMultiplier111; // constant to be varied
...
#else
void TransfAddCpixelVaryV1Iteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	double4 tempVC = fractal->transformCommon.constantMultiplier111; // constant to be varied
	if (aux->i < fractal->transformCommon.startIterations250)
	{
		;
	}
