...
void MengerMiddleModIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
...
#else
void MengerMiddleModIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{ // fabs() and menger fold
	*z = fabs(*z + fractal->transformCommon.additionConstantA000);
	if (z->x - z->y < 0.0)
	{
