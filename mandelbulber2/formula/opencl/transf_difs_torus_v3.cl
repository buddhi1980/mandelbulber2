 ...
 * from the function "TransfDIFSTorusV3Iteration" in the file fractal_formulas.cpp
...
REAL4 TransfDIFSTorusV3Iteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	aux->dist = min(aux->dist, native_divide((streD - fractal->transformCommon.offsetA05), aux->DE));
	return z;
}