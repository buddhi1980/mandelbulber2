...
inline void MandelbulbIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
inline void MandelbulbIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
