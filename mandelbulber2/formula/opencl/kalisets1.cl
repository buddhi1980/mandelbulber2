...
void Kalisets1Iteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void Kalisets1Iteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
