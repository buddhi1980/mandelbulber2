...
float4 MandelbulbKaliMultiIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 MandelbulbKaliMultiIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
