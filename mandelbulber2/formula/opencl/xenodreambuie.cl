...
inline void XenodreambuieIteration(float3 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
inline void XenodreambuieIteration(double3 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
