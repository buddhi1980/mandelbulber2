...
float4 MsltoeSym4ModIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 MsltoeSym4ModIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
