...
float4 AexionOctopusModIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 AexionOctopusModIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
