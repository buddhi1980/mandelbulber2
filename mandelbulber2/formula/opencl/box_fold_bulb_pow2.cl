...
void BoxFoldBulbPow2Iteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	(void)aux;
...
#else
void BoxFoldBulbPow2Iteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	(void)aux;
	if (fabs(z->x) > fractal->foldingIntPow.foldFactor)
