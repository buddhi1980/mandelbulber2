...
float4 Abox4dIteration(float4 *z4D, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
...
#else
double4 Abox4dIteration(double4 *z4D, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{ // parabolic = paraOffset + iter *slope + (iter *iter *scale)
