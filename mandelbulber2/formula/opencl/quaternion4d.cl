...
float4 Quaternion4dIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	z = (float4){z.x * z.x - z.y * z.y - z.z * z.z - z.w * z.w, z.x * z.y, z.x * z.z, z.w};
...
#else
double4 Quaternion4dIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	z = (double4){z.x * z.x - z.y * z.y - z.z * z.z - z.w * z.w, z.x * z.y, z.x * z.z, z.w};
	z *= fractal->transformCommon.constantMultiplier1220;
	z += fractal->transformCommon.additionConstant0000;
