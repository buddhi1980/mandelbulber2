...
float4 Quaternion4dIteration(float4 *z4D, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	*z4D = (float4){z4D->x * z4D->x - z4D->y * z4D->y - z4D->z * z4D->z - z4D->w * z4D->w,
		z4D->x * z4D->y, z4D->x * z4D->z, z4D->w};
...
#else
double4 Quaternion4dIteration(double4 *z4D, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	*z4D = (double4){z4D->x * z4D->x - z4D->y * z4D->y - z4D->z * z4D->z - z4D->w * z4D->w,
		z4D->x * z4D->y, z4D->x * z4D->z, z4D->w};
	*z4D *= fractal->transformCommon.constantMultiplier1220;
	*z4D += fractal->transformCommon.additionConstant0000;
