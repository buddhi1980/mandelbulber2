...
void MsltoeSym2ModIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void MsltoeSym2ModIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
