...
float4 MengerCrossKIFSIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	{ // CrossMengerKIFS
		...
		float4 edge = fractal->transformCommon.offset222;
		...
		z -= (float4){SQRT_3_4, 1.5f, 1.5f, 0.0f} * (fractal->transformCommon.scale3 - 1.0f);
...
#else
double4 MengerCrossKIFSIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	{ // CrossMengerKIFS
		...
		double4 edge = fractal->transformCommon.offset222;
		if (fractal->transformCommon.functionEnabledxFalse)
		{
			z.x = edge.x - z.x;
			z.y = edge.y - z.y;
		...
		z *= fractal->transformCommon.scale3;
		z -= (double4) {SQRT_3_4, 1.5, 1.5, 0.0) * (fractal->transformCommon.scale3 - 1.0};
		aux->DE *= fractal->transformCommon.scale3;
