...
void PseudoKleinianMod2Iteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
			...
			&& aux->i < fractal->transformCommon.stopIterationsT1)
	{
		...
		*z = (float4){(tempXZ - z->y) * SQRT_1_2, (tempXZ + z->y) * SQRT_1_2,
			z->x * SQRT_1_3 + z->z * SQRT_2_3, 0.0f};
...
#else
void PseudoKleinianMod2Iteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
