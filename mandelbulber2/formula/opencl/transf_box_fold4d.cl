...
void TransfBoxFold4dIteration(float4 *z4D, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void TransfBoxFold4dIteration(double4 *z4D, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	if (z4D->x > fractal->mandelbox.foldingLimit)
	{
		z4D->x = fractal->mandelbox.foldingValue - z4D->x;
