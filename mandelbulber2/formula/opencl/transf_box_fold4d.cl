...
float4 TransfBoxFold4dIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 TransfBoxFold4dIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	if (z.x > fractal->mandelbox.foldingLimit)
	{
		z.x = fractal->mandelbox.foldingValue - z.x;
