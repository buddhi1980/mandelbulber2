...
float4 TransfBenesiT2Iteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 TransfBenesiT2Iteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
