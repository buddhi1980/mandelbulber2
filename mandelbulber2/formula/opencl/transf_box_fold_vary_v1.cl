...
void TransfBoxFoldVaryV1Iteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void TransfBoxFoldVaryV1Iteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
