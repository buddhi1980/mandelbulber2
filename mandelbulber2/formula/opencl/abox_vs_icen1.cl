...
void AboxVSIcen1Iteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void AboxVSIcen1Iteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
