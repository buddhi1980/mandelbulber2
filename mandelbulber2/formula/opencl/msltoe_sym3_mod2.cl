...
float4 MsltoeSym3Mod2Iteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 MsltoeSym3Mod2Iteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
