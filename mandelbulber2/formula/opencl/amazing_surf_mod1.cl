...
void AmazingSurfMod1Iteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	aux->actualScale = mad(
...
#else
void AmazingSurfMod1Iteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	aux->actualScale = mad(
