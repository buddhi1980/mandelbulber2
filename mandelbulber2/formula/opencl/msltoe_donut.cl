...
void MsltoeDonutIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	float rad2 = fractal->donut.ringThickness;
	...
	float t = mad(-rad2, rad2, mad(R2, R2, z->z * z->z));
...
#else
void MsltoeDonutIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	double t = mad(-rad2, rad2, mad(R2, R2, z->z * z->z));
