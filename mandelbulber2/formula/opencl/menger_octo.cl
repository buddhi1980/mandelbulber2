...
float4 MengerOctoIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{ // octo
...
#else
double4 MengerOctoIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{ // octo
	if (aux->i >= fractal->transformCommon.startIterationsE
			&& aux->i < fractal->transformCommon.stopIterationsE)
	{
