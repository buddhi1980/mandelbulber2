...
float4 BuffaloIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 BuffaloIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
