...
inline void BuffaloIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
inline void BuffaloIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
