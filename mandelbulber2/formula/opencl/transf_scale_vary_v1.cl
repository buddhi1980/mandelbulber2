...
void TransfScaleVaryV1Iteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void TransfScaleVaryV1Iteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
