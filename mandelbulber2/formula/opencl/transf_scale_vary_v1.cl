...
float4 TransfScaleVaryV1Iteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	float tempVC = fractal->transformCommon.scale; // constant to be varied
...
#else
double4 TransfScaleVaryV1Iteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
