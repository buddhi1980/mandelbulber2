...
float4 IqBulbIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 IqBulbIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// extract polar coordinates
	double wr = aux->r;
