...
void MandelboxSmoothIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void MandelboxSmoothIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
