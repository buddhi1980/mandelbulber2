...
void TransfBoxFoldXYZIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void TransfBoxFoldXYZIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	if (z->x > fractal->transformCommon.additionConstant111.x)
	{
		z->x = fractal->transformCommon.additionConstant222.x - z->x;
