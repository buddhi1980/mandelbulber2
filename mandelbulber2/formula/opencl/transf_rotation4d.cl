...
float4 TransfRotation4dIteration(float4 *z4D, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
// temp 4D rotation
{
	Q_UNUSED(aux);
...
#else
double4 TransfRotation4dIteration(double4 *z4D, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
// temp 4D rotation
{
	Q_UNUSED(aux);
