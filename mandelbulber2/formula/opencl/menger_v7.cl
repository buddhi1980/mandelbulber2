...
REAL4 MengerV7Iteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	for (int n = 0; n < fractal->transformCommon.int16; n++)
	{
		...
		REAL3 q = (REAL3)(1.0, 0.0, 0.0);
		if (children >= 3 || mat_struct == 3) q = (REAL3)(1.0, 1.0, 1.0);
		REAL3 p1 = p - q;
		REAL3 p2 = p - (REAL3)(1.0, 0.0, 1.0);


		if (!fractal->transformCommon.functionEnabledMFalse)
		{
			if (children < 2)
				p2 = p - (REAL3)(2.0, 0.0, 0.0);
		}
		else
		{
			p2 = p - (REAL3)(2.0, 0.0, 0.0);
		}
		REAL3 p3 = p - (REAL3)(1.0, 1.0, 0.0);
		REAL3 p4 = p; //- (REAL3)(0.0, 0.0, 0.0);
