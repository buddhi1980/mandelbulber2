...
void CollatzModIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	float4 c = aux->const_c;

	*z =
		fractal->transformCommon.constantMultiplierB111
...
#else
void CollatzModIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
