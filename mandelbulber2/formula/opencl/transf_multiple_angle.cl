...
void TransfMultipleAngleIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
void TransfMultipleAngleIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
