...
void TransfInvCylindricalIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	float newZx = z->x;
	float newZy = z->y;
	...
	*z = (float4){z->x * native_cos(newZy * fractal->transformCommon.scale1),
...
#else
void TransfInvCylindricalIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	double newZx = z->x;
	double newZy = z->y;
	...
	*z = (double4){z->x * native_cos(newZy * fractal->transformCommon.scale1),
				 newZx * native_sin(z->y * fractal->transformCommon.scale1),
				 z->z * fractal->transformCommon.scaleC1, z->w}
			 * fractal->transformCommon.scaleA1;
