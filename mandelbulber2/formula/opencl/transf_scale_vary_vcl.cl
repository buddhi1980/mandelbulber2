...
void TransfScaleVaryVCLIteration(float4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	float para = 0.0f;
...
#else
void TransfScaleVaryVCLIteration(double4 *z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	double para = 0.0;
