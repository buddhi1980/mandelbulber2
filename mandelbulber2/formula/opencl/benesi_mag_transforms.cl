...
float4 BenesiMagTransformsIteration(float4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
...
#else
double4 BenesiMagTransformsIteration(double4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
