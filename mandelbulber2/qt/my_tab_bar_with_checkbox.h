...
#ifndef MANDELBULBER2_QT_MY_TAB_BAR_WITH_CHECKBOX_H_
#define MANDELBULBER2_QT_MY_TAB_BAR_WITH_CHECKBOX_H_

#include <QMap>
#include <QTabBar>

class MyTabBarWithCheckBox : public QTabBar
{
	Q_OBJECT
...
#endif /* MANDELBULBER2_QT_MY_TAB_BAR_WITH_CHECKBOX_H_ */
